    ...
    <div className="container mx-auto px-6 relative z-10">
      <AnimatedElement className="max-w-2xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
          Ready to stop losing customers to your inbox?
        </h2>
        <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
          Start your 14-day free trial today. No credit card required. Set up in under an hour.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 border border-border text-foreground px-8 py-4 rounded-lg text-base font-medium hover:border-border-hover transition-colors"
          >
            Talk to us
          </Link>
        </div>
